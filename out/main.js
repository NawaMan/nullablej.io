...
var author$project$Main$initialModel = function (flag) {
	return _Utils_Tuple2(
		{exampleIndex: 0, usage: author$project$Main$Gradle},
...
var author$project$Main$sectionBottom = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text('© 2017-2019 NawaMan\'s NullableJ.io — NullableJ.io is Open Source, '),
					A2(
					elm$html$Html$a,
					_List_fromArray(
						[
							elm$html$Html$Attributes$href('https://github.com/NawaMan/NullableJ/blob/master/LICENSE')
						]),
					_List_fromArray(
						[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$href('https://github.com/NawaMan/NullableJ')
						]),
					_List_fromArray(
						[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Be be added later.')
					]))
			]));
};
		...
		[
			...
			_List_fromArray(
				[
					...
					elm$html$Html$text(' hosted on GitHub. So to use NullableJ.io you will need to ...')
				])),
			A2(
			elm$html$Html$p,
			_List_Nil,
			...
			_List_fromArray(
				[
					elm$html$Html$text('and the dependencies to NullableJ.io.')
				])),
			author$project$CodeBlock$codeBlock('compile \'io.nullablej:nullablej-all:4.0.0.0\' // Please lookup for the latest version.'),
			A2(
			elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$href('https://github.com/NawaMan/UseNullableJGradle')
						]),
					_List_fromArray(
						[
							elm$html$Html$text('UseNullableJGradle')
						])),
					elm$html$Html$text(' is an example project that use NullableJ.io. You can use that as a starting point.')
				]))
		]));
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$href('https://github.com/NawaMan/UseNullableJMaven')
						]),
					_List_fromArray(
						[
							elm$html$Html$text('UseUseNullableJMaven')
						])),
					elm$html$Html$text(' is an example project that use UseNullableJ.io. You can use that as a starting point.')
				]))
		]));
